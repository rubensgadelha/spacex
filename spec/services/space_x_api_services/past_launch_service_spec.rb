...
RSpec.describe SpaceXApiServices::PastLaunchesService do
  
  describe ".call" do
    
    it "should return past launches info" do
      ...
      result = SpaceXApiServices::PastLaunchesService.call
    ...
    it "should return error when SpaceX api call return an error" do
      ...
      expect { SpaceXApiServices::PastLaunchesService.call }.to raise_error RestClient::Unauthorized
    end
  end
end